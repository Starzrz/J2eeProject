...
$(document).ready(function() {
    ...
    $(function () {
        doGet('/manager/askmHostInfo',function(data){
            console.log(data)

            $('#performCount').html(data.performCount);
            $('#orderCount').html(data.orderCount);

            $('#name').val(data.name);
            $('#place').val(data.place);
            $('#xsites').val(data.xsites);
            $('#ysites').val(data.ysites);
            $('#vip1').val(data.vip1);
            $('#vip2').val(data.vip2);
    ...
    $(function() {
        ...
        doGet('/9view/askMHchart', function(data){
            ...
            console.log(data);
            for(var i=0;i<x;i++){
                // console.log(data[i][0].replace(/-/g,"/"));
                d1.push([new Date(data[i][0].replace(/-/g,"/")).getTime(),data[i][1]*1])
            }
            console.log(d1);
            // d1.push(data);
            var chartMinDate = d1[0][0]; //first day
            var chartMaxDate = d1[x-1][0];//last day
    ...
    $(function() {
        ...
        doGet('/9view/askMHIncomeChart', function(data){
